...
mysqli_query($koneksi,"update npsn_satu set status=2, acc=2, disposisi=2 where id_sekolah='$id_sekolah'");


        echo "<script>alert('Email berhasil terkirim!');window.location='../staf_npsn.php';</script>";
