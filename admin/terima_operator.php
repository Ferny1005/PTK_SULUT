...
try {
    ...
    $mail->Body    = "Sehubung dengan pembuatan akun untuk kepengurusan PTK yang tersedia, dengan ini Kami dari Pihak Dinas Pendidikan Daerah Sulawesi Utara menyampaikan bahwa Akun tersebut <b>DITERIMA</b><br/> silahkan melanjutkan login untuk memulai pengajuan <br>";
    $mail->AltBody = '';
    //$mail->AddEmbeddedImage('gambar/logo.png', 'logo'); //abaikan jika tidak ada logo
    //$mail->addAttachment(''); 

    $mail->send();
    echo "<script>alert('Email Operator Diterima berhasil terkirim!');window.location='../pejabat_btikp.php';</script>";

mysqli_query($koneksi,"update sekolah set acc='1' where npsn='$npsn'");
