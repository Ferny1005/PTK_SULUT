    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin_npsn.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin_npsn.php?p=riw_smk">
                    <span>SMK</span></a>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="admin_npsn.php?p=riw_sma">
                    <span>SMA</span></a>
            </li>
             <li class="nav-item">
                <a class="nav-link" href="admin_npsn.php?p=riw_slb">
                    <span>SLB</span></a>
            </li>
             <hr class="sidebar-divider">
             <li class="nav-item">
...
<div class="container-fluid">
    ...
    {
        default :
        include ('admin/daftar_disposisi_npsn.php');
        break;
