    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
          ...
          <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="kabid_gtk.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="kabid_gtk.php?p=riw_swasta">
                    <span>Swasta</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="kabid_gtk.php?p=riw_negeri">
                    <span>Negeri</span></a>
            </li>
             <hr class="sidebar-divider">
             <li class="nav-item">
...
<div class="container-fluid">
    ...
    {
        default :
        include ('admin/daftar_disposisi_ptk.php');
        break;
